...
async def _(event):
    ...
    animation_chars = [
        ...
        "__INFO:ANGELX: Logged in as 581993043__",
        "__INFO:ANGELX: Successfully loaded all plugins__",
        "__INFO:ANGELX: Successfully deployed Telegram v69.6.9 to Heroku__",
        "__INFO:ANGELX: Processing the App__",
        "**Build Succeeded**",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
